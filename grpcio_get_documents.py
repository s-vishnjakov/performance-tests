...
open_savings_card_account_request = OpenSavingsAccountRequest(
    user_id=create_user_response.user.id
)
open_savings_card_account_response: OpenSavingsAccountResponse = (
    accounts_gateway_service.OpenSavingsAccount(open_savings_card_account_request)
)
print('Open credit card account response:', open_savings_card_account_response)
